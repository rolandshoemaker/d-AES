...
if __name__ == "__main__":
	key = [62, 142, 78, 2, 164, 231, 18, 196, 148, 177, 82, 186, 240, 44, 136, 242, 23, 13, 20, 169, 248, 69, 163, 79, 13, 155, 97, 200, 241, 15, 76, 15]
	#plain = [49, 50, 51, 52, 53, 54, 55, 56, 57, 48, 97, 98, 99, 100, 101, 102]
	#cipher = aesEncrypt(plain, key)
	#clear = aesDecrypt(cipher, key)
	#print(str(plain==clear))
	#print(clear)
	plain = "o4jdmg a8ffdawde90q2834 0qa9isd  kfaoaaa"
	hard = encrypt(plain, key)
	#for b in hard:
	#	print(ord(b))
	decd = decrypt(hard, key)
	#for b in decd:
	#	print(ord(b))
	print(str(plain==decd))
	print(plain)
	print(decd)
